  ...
  loadImages: function(datasets){
    ...
    for(let dataset of datasets){
      for(let key in dataset){
        ...
        if(typeof dataset[key].img === 'object' && (dataset[key].img.hasOwnProperty('red') || dataset[key].img.hasOwnProperty('horizontal') || dataset[key].img.hasOwnProperty('top'))){
          response[key] = {};
